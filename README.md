...
![](images/setup.png) <!-- .element height="50%" width="50%" -->

## Overview
The app can display the raw EMG data or show a live feed that shows your performance per individual muscle.
![](images/sensor.png | width=350) <!-- .element height="50%" width="50%" --> ![](images/screen1.png | width=350) <!-- .element height="50%" width="50%" -->
